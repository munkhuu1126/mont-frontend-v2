...
export default function Cards({ year, circulatingfee, reservefee, cardbg, file }) {
  ...
  return (
    <div className={`${cardbg} text-blue-700 p-10 rounded-lg`}>
      ...
      {
        file === "https://news.stablecoin.mn/assets/null" ? '':
        <a className="mb-5 border border-blue-700 hover:shadow-xl hover:text-white hover:bg-blue-500 p-1 rounded-lg transition duration-200 ease-in" 
        href={file} 
        target="_blank" 
